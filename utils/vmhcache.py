...
class VMHCacheClient:
    def __init__(self, cache_file="/home/javad/pyprojects/MO_GEMs_Score/GraphRAG/data/vmh_metabolite_cache.csv"):
    ...
    def _save_cache(self):
        ...
        with open(self.cache_file, 'w', newline='') as f:
            writer = csv.DictWriter(f, fieldnames=["reaction", "met_abbreviation", "name", "description",
                            "seed_id", "kegg_id", "pubchem_id"])
            writer.writeheader()
    ...
    def get_met_info(self, rxnList):
        ...
        for rx in rxnList:
            ...
            if not met_abbr:
                self.cache[rx] = {
                    "reaction": rx, "met_abbreviation": "",
                    "name": "", "description": "", "seed_id": "",
                    "kegg_id": "", "pubchem_id": ""
                }
            else:
                ...
                if not data or "error" in data:
                    print(data)
                    self.cache[rx] = {
                        "reaction": rx, "met_abbreviation": met_abbr,
                        "name": "", "description": "", "seed_id": "",
                        "kegg_id": "", "pubchem_id": ""
                    }
                else:
